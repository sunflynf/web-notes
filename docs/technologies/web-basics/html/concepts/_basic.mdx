...
| div                    | Defines a section in a document (block-level)                                                | [Block & Inline Elements](#block--inline-elements)                                                                              |
| span                   | Defines a section in a document (inline)                                                     | [Block & Inline Elements](#block--inline-elements)                                                                              |
...
- `script` is used to define client-side [JavaScript](../../../js/index.mdx).
